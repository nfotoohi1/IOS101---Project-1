  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      ...
      case LetterCellStyle.incorrect:
          let red = UIColor(red: 0.23, green: 0.23, blue: 0.24, alpha: 1.0)
          contentView.backgroundColor = red
          layer.borderColor = red.cgColor
          break
      case LetterCellStyle.correctLetterOnly:
          let yellow = UIColor(red: 0.69, green: 0.63, blue: 0.30, alpha: 1.0)
          contentView.backgroundColor = yellow
          layer.borderColor = yellow.cgColor
          break
      case LetterCellStyle.correctLetterAndPosition:
          let green = UIColor(red: 0.38, green: 0.55, blue: 0.33, alpha: 1.0)
