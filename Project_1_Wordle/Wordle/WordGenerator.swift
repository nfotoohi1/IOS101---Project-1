...
class WordGenerator {
  ...
  static let possibleWords = ["CAFES", "EARTH", "CLOUD", "PLUCK", "DUCKS", "QUERY", "CAMEO", "WHITE", "WORDS", "PLUMB", "PLUMS", "LYRIC", "WRITE", "GREEN", "CANOE", "LIMES", "SOUND", "THEIR", "GOING", "WANTS", "WHOLE", "FUNNY", "FACES", "SWEET", "BEATS", "CREAM", "HOMES", "BLUES", "CHAIR", "LATER", "CUTIE", "MARKS", "GREAT", "RIGHT", "OTHER", "LIKED", "HONOR", "START", "EDITS", "PLAID", "YEAST", "FEAST", "FEATS", "BLURT", "IDEAL", "LEERY", "PIOUS", "GHOUL", "SONGS", "AFTER", "SUCKS", "OFFER", "STILL", "STAND", "TOWNS", "CHURN", "AUDIO"]
